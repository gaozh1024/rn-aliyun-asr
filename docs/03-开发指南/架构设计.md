...
export enum ASREvent {
  ...
  // ASR 事件
  ASR_PARTIAL_RESULT = 8,   // 中间识别结果
  ASR_RESULT = 9,           // 最终识别结果
  ASR_ERROR = 10,           // 识别错误
  ASR_STARTED = 33,         // 识别开始

  // 句子级事件（长文本识别）
  SENTENCE_START = 23,      // 句子开始
  SENTENCE_END = 24,        // 句子结束
  SENTENCE_SEMANTICS = 25,  // 语义结果
...
export interface ASRInitConfig {
  ...
  enableRecorderByUser?: boolean; // 是否业务侧自己喂音频，默认 false
  serviceType?: 'asr' | 'speechTranscriber'; // 服务类型，默认 asr
